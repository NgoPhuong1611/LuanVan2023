...
<body>
    ...
    <div class="span1.0">
        <div class="thumbnail well">
            ...
            <div class="caption">
                <b>PART 5</b>
                <a href="{{ url('Practice/Read/'.$part5[0]['id']) }}" class="btn btn-primary">Exam now</a>
            </div>
        </div>
    </div>
    ...
    <div class="span1.0">
        <div class="thumbnail well">
            ...
            <div class="caption">
                <b>PART 6</b>
                <a href="{{ url('Practice/Read/'.$part6[0]['id']) }}" class="btn btn-primary">Exam now</a>
            </div>
        </div>
    </div>
    ...
    <div class="span1.0">
        <div class="thumbnail well">
            ...
            <div class="caption">
                <b>PART 7</b>
                <a href="{{ url('Practice/Read/'.$part7[0]['id']) }}" class="btn btn-primary">Exam now</a>
            </div>
        </div>
    </div>
