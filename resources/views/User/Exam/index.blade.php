    ...
    <div id="resultsearchGrammar">
        <div class="row">
            <div class="span9">
                ...
                <div class="span9">
                    <div class="span3">
                        <img class="imageGrammar" src="<?= base_url() ?>resources/file/images/grammar/27.thi_htht_anhngumshoa.jpg" />
                    </div>
                    <div class="span1"></div>
                    ...
                    <div class="span5">
                        ...
                        <div>
                            <a href="<?= base_url('Exam/ExamToeic') ?>" class="btn btn-primary">Làm Bài</a>
                        </div>
                    </div>
                </div>
                <br>
