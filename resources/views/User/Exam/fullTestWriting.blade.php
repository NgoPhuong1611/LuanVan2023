            ...
            <div style="display: block;">
                <p>
                    <a href="<?= base_url('user') ?>" id="backhome" style="display: inline;">
                        Home</a> <span>Bài test Writing</span>
                </p>
            </div>
                    ...
                    <div id="main" class="col-md-8 web-font">
                        ...
                        <c:forEach items="${listQuestion}" var="list">
                            ...
                            <c:if test="${not empty list.image}">
                                ...
                                <form action="/questions/{{ $question->id }}/submit-answer" method="POST">
                                    @csrf
                                    <textarea name="answer" rows="4" cols="50" placeholder="Nhập câu trả lời của bạn"></textarea><br><br>
