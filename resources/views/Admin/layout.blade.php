...
<link rel="stylesheet" type="text/css" href="{{ asset('templates/libraries/assets/icon/themify-icons/themify-icons.css') }}">
...
<link type="text/css" rel="stylesheet" href="{{ asset('templates/libraries/assets/pages/jquery.filer/css/themes/jquery.filer-dragdropbox-theme.css') }}">
...
<script src="{{ asset('templates/libraries/bower_components/select2/js/select2.full.min.js') }}"></script>

<!-- Validation js -->
<script src="https://cdnjs.cloudflare.com/ajax/libs/underscore.js/1.8.3/underscore-min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.10.6/moment.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/js/bootstrap.bundle.min.js"></script>
<script src="{{ asset('templates/libraries/assets/pages/form-validation/validate.js') }}"></script>
<!-- Required Jquery -->
<script src="{{ asset('templates/libraries/bower_components/jquery/js/jquery.min.js') }}"></script>
<script src="{{ asset('templates/libraries/bower_components/jquery-ui/js/jquery-ui.min.js') }}"></script>
<script src="{{ asset('templates/libraries/bower_components/popper.js/js/popper.min.js') }}"></script>
<script src="{{ asset('templates/libraries/bower_components/bootstrap/js/bootstrap.min.js') }}"></script>
...
<script src="{{ asset('templates/libraries/bower_components/jquery-slimscroll/js/jquery.slimscroll.js') }}"></script>
<!-- data-table js -->
...
<!-- notification js -->
<script src="{{ asset('templates/libraries/assets/js/bootstrap-growl.min.js') }}" type="text/javascript"></script>
<script src="{{ asset('templates/libraries/assets/pages/notification/notification.js') }}" type="text/javascript"></script>

<!-- modernizr js -->
<script src="{{ asset('templates/libraries/bower_components/modernizr/js/modernizr.js') }}"></script>
...
<!-- i18next.min.js -->
<script src="{{ asset('templates/libraries/bower_components/i18next/js/i18next.min.js') }}"></script>
