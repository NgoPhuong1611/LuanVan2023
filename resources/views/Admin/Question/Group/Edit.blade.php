									...
									<div class="card">
										...
										<div class="card-block">
											<div class="edit-info">
												<div class="row">
													<div class="col-lg-12">
														<form action="<?= url('dashboard/question-group/update/'.$questionGroup['id']) ?>" method="post">
                                                        @csrf
																	...
																	<div class="col-md-12">
																		...
																		<div class="input-group">
																			<select name="type" class="form-control" required>
																				...
																				<option value="2" selected <?= isset($question) && !empty($question) && $question['type'] == 2 ? 'selected' : '' ?>>Câu hỏi đọc</option>
																			</select>
																		</div>
																	</div>
																</div>
