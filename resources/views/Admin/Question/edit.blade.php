                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-block">
                                            <div class="edit-info">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <form action="<?= url('dashboard/question/update/'.$question['id']) ?>" method="POST" enctype="multipart/form-data">
                                                            @csrf
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12 mb-3">
                                                                        <label for="question">Câu hỏi</label>
                                                                            <textarea type="text" id="editor5" class="form-control field" name="question" placeholder="Câu hỏi ..." rows="5" autofocus><?= isset($question) && !empty($question) ? $question['question'] : set_value('question') ?></textarea>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div class="input-group">
                                                                            <select name="type" class="form-control" required>
                                                                                ...
                                                                                <option value="3" <?= isset($question) && !empty($question) && $question['type'] == 3 ? 'selected' : '' ?>>Câu hỏi nói</option>
                                                                                <option value="4" <?= isset($question) && !empty($question) && $question['type'] == 4 ? 'selected' : '' ?>>Câu hỏi viết</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                                ...
                                                                                <div class="jFiler-item-container">
                                                                                    <div class="jFiler-item-inner">
                                                                                        ...
                                                                                        <div class="jFiler-item-info pull-left">
                                                                                            <div class="jFiler-item-title" title="<?= $image['image_name'] ?>"><a href="<?= url('uploads/images/' . $image['image_name']) ?>" target="_blank" rel="noopener noreferrer"><?= $image['image_name'] ?></a></div>
                                                                                            <!-- <img src="<?= url('uploads/images/' . $image['image_name']) ?>" alt="<?= $image['image_name'] ?>"> -->
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </li>
