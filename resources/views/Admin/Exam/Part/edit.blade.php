                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-block">
                                            <div class="edit-info">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <form action="<?= url('dashboard/exam-part/update/'.$examPart['id']) ?>" method="post">
                                                        @csrf
                                                            ...
                                                            <div class="general-info">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12 text-right">
                                                                        ...
                                                                        <a href="<?= url('dashboard/exam/part-exam') ?>" id="edit-cancel" class="btn btn-default waves-effect">Huỷ</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <!-- end of edit info -->
